...
if __name__=="__main__":
    ...
    parser.add_argument('--image-path', type=str, default='playground/data/eval/mm-vet/images/v1_123.jpg')
    parser.add_argument('--prompt', type=str, default='Describe this image in detail.')
    parser.add_argument('--output-path', type=str, default='./output_example')
